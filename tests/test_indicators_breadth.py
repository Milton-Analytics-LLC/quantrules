...
class TestAdvanceDeclineLine:
    ...
    def test_missing_count_makes_later_values_unknown(self) -> None:
        """A missing advance/decline count leaves the running total unknown thereafter."""
        result = advance_decline_line(
            series([100.0, float("nan"), 90.0]), series([80.0, 100.0, 110.0])
        )
